...
loc="/Users/ccmiller/git/cbbmap/src/offline"
...
# curl "http://comedybangbang.wikia.com/api/v1/Articles/List?limit=8445&callback=?" -o /Users/ccmiller/git/cbbmap/src/offline/wikiaz.json
