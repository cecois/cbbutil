...
"use strict";var Locations=Backbone.Collection.extend({model:Bit,initialize:function(t){t||(t={})},url:function(){var t=null;switch(CONFIG.mode){case"T":t="http://localhost:3030/geoms/offline?q="+appState.get("locations");break;case"33":t="http://localhost:3030/geoms/cbb?q="+appState.get("locations");break;default:t="http://milleria.org:3030/geoms/cbb?q="+appState.get("locations")}return t},sync:function(t,a,e){return e.dataType="jsonp",e.jsonpCallback="cwmccallback",Backbone.sync(t,a,e)}});
