...
"use strict";var Updates=Backbone.Collection.extend({model:Update,url:"offline/update.json",initialize:function(e){return e||(e={}),this},sync:function(e,n,t){return t.dataType="json",t.async=!0,t.url=this.url,t.method="GET",Backbone.sync(e,n,t)},parse:function(e){return console.log("data",e),appQuery.set({raw:e.query}),e}});
