...
,AWS = require('aws-sdk')
,AWSHTTPCLIENT = require('http-aws-es')
...
let mapd = _MAPBITS(JSON.parse(FS.readFileSync(CONFIG.budir+"/"+J)));
let prefixes = [];
