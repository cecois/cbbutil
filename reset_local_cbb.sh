...
mongoexport --db cbbbits --collection bits --fields '_id,show,episode,slug_earwolf,id_wikia,url_soundcloud,name,desc,elucidation,tags,tstart,tend,location_type,location_id,holding' --jsonArray --out /tmp/bits_incoming.json
#	WINNER-----!!!!
